...
# Paths to toolchains
ARM_CORTEX_A8_TOOLCHAIN=~/x-tools/arm-cortex_a8-linux-gnueabihf
ARM_QEMU_TOOLCHAIN=~/x-tools/arm-unknown-linux-gnueabi
BUSYBOX_SRC=~/busybox

# Staging directories
ROOTFS_BBB=~/rootfs-bbb
ROOTFS_QEMU=~/rootfs-qemu
